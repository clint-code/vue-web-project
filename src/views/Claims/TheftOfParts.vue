      ...
      <template v-if="!showSummary">
        ...
        <template v-if="!secondForm">
          ...
          <CustomButton label="Save and Continue" icon="fa-arrow-circle-right"
            bgColor="bg-yellow-500 font-medium text-lg mt-4 mb-4" @click="saveAndContinue" />
        </template>
        ...
        <template v-else>
          ...
          <!-- Submit Button -->
          <CustomButton label="Submit" icon="fa-circle-arrow-right"
            bgColor="bg-yellow-500 text-lg font-semibold mb-4 mt-4" @click="handleSubmit" />
        </template>
      </template>
      ...
      <template v-else>
        ...
        <div class="summary-table mt-2">
          <div class="flex justify-content-between align-items-center py-3 border-bottom-1 border-gray-400">
            ...
            <p class="m-0 font-medium">Theft of Vehicle Parts</p>
          </div>
