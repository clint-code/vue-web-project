  ...
  <div class="custom-mobile-view">
    <div class="px-3 pt-4 overflow-y-auto mb-4 relative">
      ...
      <div class="my-4">
        <div>
          <div
            class="w-full border-round-2xl custom-dark-gray-border border-1 custom-dark-gray-bg p-3 custom-accordion"
            v-if="!lipaFullDetails"
          >
            <div class="flex justify-content-between">
              <label class="font-bold text-sm text-white w-6"
                >Lipa in Full</label
              >
              <label class="font-bold text-sm text-white text-right w-6"
                >KES {{ quoteSummary.LipaFullAmount.toLocaleString() }}</label
              >
            </div>

            <div class="flex justify-content-between gap-4">
              <div
                class="flex justify-content-center w-6 bg-white border-round-3xl mt-3"
              ...
              <div
                class="flex justify-content-center w-6 bg-yellow-500 border-round-3xl mt-3"
                @click="submit()"
              >
        ...
        <div class="relative" v-if="lipaFullDetails">
          <div
            class="w-full custom-light-gray-bg-1 border-round-bottom-3xl p-3 z-1"
          >
            <div class="mt-8">
            ...
            <div class="mt-3">
              ...
              >
                ...
                <label class="font-bold text-sm text-alpha-90"
                  >KES {{ quoteSummary.LipaFullAmount.toLocaleString() }}</label
                >
                <i
                  class="fas fa-circle-arrow-right text-black-alpha-90 text-sm text-alpha-90"
                ></i>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div
              class="flex justify-content-between gap-4"
              @click="toggleLipaFullDetails()"
            >
              <div
                class="flex justify-content-center w-6 bg-white border-round-3xl mt-3"
        ...
        <div class="relative" v-if="lipaPolePoleDetails">
          ...
          >
            ...
            <div class="mt-4">
              <label class="font-bold"
                >Customise your lipa pole pole plan</label
              >

              <div class="flex flex-column mt-4">
                <label class="font-bold text-sm">Deposit Amount</label>
                <InputText
                  class="border-round-3xl text-sm mt-2"
                  placeholder="Enter amount above 25,000"
                />
              </div>

              <div class="flex flex-column mt-4">
                <label class="font-bold text-sm"
                  >Installment Period (Upto 10 Months)</label
                >
                <Dropdown
                  v-model="selectedInstallmentPeriod"
                  :options="installmentsArray"
                  placeholder="Choose"
                  class="border-round-3xl custom-dark-dropdown custom-md-dropdown mt-2"
                  optionLabel="name"
                />
              </div>
            </div>
            ...
            <div class="mt-4">
              ...
              >
                ...
                <i
                  class="fas fa-circle-arrow-right text-black-alpha-90 text-sm text-white"
                ></i>
              </div>
            </div>
            ...
            <div class="mt-3">
              ...
              >
                ...
                <template v-if="quoteSummary.LipaPolePoleDeposit">
                  <label class="text-sm font-bold text-right w-8"
                    >KES
                    {{
          ...
          >
            <div class="flex justify-content-between">
              ...
              >
              <label class="font-bold text-sm text-white text-right w-6"
                >KES {{ quoteSummary.LipaPolePoleDeposit.toLocaleString() }}</label
              >
            </div>
      ...
      <div class="grid">
        <div class="lg:col-10 relative">
          <div class="mb-4">
            ...
            <div class="mt-5">
              <div
                class="w-full border-round-3xl bg-yellow-500 px-3 custom-py-10 custom-accordion-1"
                v-if="!summaryDetails"
              ...
              <div class="relative" v-if="summaryDetails">
                <div
                  class="w-full custom-gray-border border-1 border-round-bottom-3xl border-top-none p-3 z-1"
                >
                  <QuoteDetails quoteType="Lipa Full" />
                ...
                <div
                  class="w-full border-round-3xl bg-yellow-500 px-3 custom-py-10 custom-accordion-body-2 z-0"
                  @click="toggleSummaryDetails()"
                >
                  <div class="flex justify-content-between">
                    <label class="font-bold text-sm">Lipa Full</label>
            ...
            <div class="mt-4">
              ...
              <div class="relative" v-if="paymentPlan">
                <div
                  class="w-full custom-gray-border border-1 border-round-bottom-3xl z-1"
                >
                  <div class="px-3 pt-3 mt-3">
                    <QuoteDetails quoteType="Lipa Pole Pole" />
                  </div>

                  <div
                    class="custom-light-gray-bg-1 border-round-bottom-3xl p-3"
                  >
                    <div>
                      <label class="font-bold"
                        >Customise your lipa pole pole plan</label
                      ...
                      <div class="grid mt-2">
                        <div class="col-6">
                          ...
                          >
                            ...
                            >
                            <i
                              class="fas fa-circle-arrow-right text-black-alpha-90 text-white"
                            ></i>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="mt-3">
                      ...
                      >
                        ...
                        >
                        <template v-if="quoteSummary.LipaPolePoleDeposit">
                          <label class="text-xs font-bold text-right w-8"
                            >KES
                            {{
                              quoteSummary.LipaPolePoleDeposit.toLocaleString()
                            }}</label
