            ...
            <div class="flex flex-column align-items-center">
                ...
                <div class="my-4 w-full">
                    <div class="flex custom-border-radius align-items-center custom-dark-gray-border border-1 px-4">
                        <Calendar class="w-full h-4rem align-items-center gap-3 custom-calendar-input pr-2"
                            :showWeek="false" v-model="valuationDate" dateFormat="dd/mm/yy" @dateSelect="changeDate()" />
                        <i class="fas fa-calendar-days text-2xl custom-gray"></i>
                    </div>

                    <Dropdown v-model="valuationTime" :options="timesArray" optionLabel="name" placeholder="Select time"
                    ...
                    <div class="flex custom-shadow-1 custom-border-radius px-4 h-4rem align-items-center gap-3 mt-4"
                        ...
                        <label class="font-bold custom-gray">{{ valuationLocation }}</label>
                    </div>
                </div>
            </div>
        </div>
...
const valuationTime = ref('Select time')
