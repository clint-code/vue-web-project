        ...
        <div class="mt-4">
            <div class="flex flex-wrap gap-3 mt-2">
                <div class="flex align-items-center" v-for="insuranceType in insuranceTypes" :key="insuranceType.name">
                    ...
                    <label for="ingredient1" class="ml-1 text-xs font-bold">{{ insuranceType.name }}</label>
                </div>
            </div>
        </div>
        ...
        <div class="grid mt-3">
            <div class="col-3">
                <Dropdown v-model="selectedCoverDuration" :options="coverDurations" optionLabel="name"
                    optionValue="value" placeholder="Cover Duration"
            ...
            <div class="col-3">
                <InputGroup class="custom-amount-input-1">
                    ...
                    <InputText class="border-round-3xl custom-dark-gray-border custom-border-1-5 text-sm"
                        v-model="estimatedValue" placeholder="Estimate value" />
                </InputGroup>
            </div>
