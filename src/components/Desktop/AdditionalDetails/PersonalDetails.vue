                ...
                <div class="relative z-1">
                    <div
                        ...
                        <div class="grid">
                            <div class="col-6">
                                <div class="flex flex-column gap-2">
                                    ...
                                    <InputText v-model="customerName" class="text-sm border-round-3xl"
                            ...
                            <div class="col-6">
                                <div class="flex flex-column gap-2">
                                    ...
                                    <Dropdown v-model="selectedIdenficationDocument" :options="identificationDocuments"
                                        optionLabel="name" optionValue="value" placeholder="Select Document"
                        ...
                        <div class="grid mt-1">
                            ...
                            <div class="col-6">
                                <div class="flex flex-column gap-2">
                                    ...
                                    <InputText v-model="kraPIN" class="text-sm border-round-3xl"
                            ...
                            <div class="col-6">
                                <div class="flex flex-column gap-2">
                                    ...
                                    <InputGroup>
                                        ...
                                        <InputText type="number" v-model="phoneNumber" class="border-round-right-3xl text-sm" placeholder="Enter Phone Number" />
                                    </InputGroup>
                                </div>                                
                            </div>
                            ...
                            <div class="col-6">
                                <div class="flex flex-column gap-2">
                                    <label class="text-sm font-medium">Email</label>
                                        <InputText v-model="email" class="text-sm border-round-3xl"
                        ...
                        <div class="w-full border-round-2xl px-3 py-2 mt-2"
                            :class="{ 'bg-yellow-500': verificationStatus, 'custom-gray-bg' : !verificationStatus }" @click="submit()">
                            <div class="flex justify-content-between align-items-center">
