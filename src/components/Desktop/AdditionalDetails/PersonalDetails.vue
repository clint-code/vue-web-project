  ...
  <div class="grid">
    <div class="lg:col-10">
      ...
      <div class="pb-4 pr-4" :style="{ 'margin-bottom': marginBottom }">
        <div
          class="relative bg-yellow-500 border-round-2xl px-3 custom-py-10 mt-3 z-2"
        >
        ...
        <div class="relative z-1">
          ...
          >
              ...
              <div class="col-6">
                <div class="flex flex-column gap-2">
                  <label class="text-sm font-medium"
                    >Enter Name (As appears on your ID)</label
                  >
                  <InputText
            ...
            <div class="grid mt-1">
              <div class="col-6">
                <div class="flex flex-column gap-2">
                  ...
                  <InputGroup>
                    <InputGroupAddon
                      class="bg-yellow-500 border-round-left-2xl"
                    >
            ...
            <div
              class="w-full border-round-2xl px-3 py-2 mt-2"
              :class="{
                'bg-yellow-500': verificationStatus,
