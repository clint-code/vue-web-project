        ...
        <div class="custom-mobile-view custom-mobile-nav">
            <template v-if="props.variation == 'fullLogo'">
                <div class="flex justify-content-between align-items-center px-3 py-2"
                    ...
                    <div class="flex">
                        ...
                        <div class="custom-icon-bg" @click="showMenuDetails()"
                            :class="{ 'bg-yellow-500' : !menuDetails, 'bg-white' : menuDetails }">
            ...
            <template v-else-if="props.variation == 'yellow'">
                <div class="flex justify-content-between align-items-center bg-yellow-500 px-3 py-2">
                    ...
                    <div>
                        <div class="flex">
                            <div class="custom-icon-bg bg-black-alpha-90 mr-3"
                                :class="{ 'bg-yellow-500' : !menuDetails, 'bg-white' : menuDetails }"
                                @click="navigate('/my-policies')">
                                <i class="fas fa-user text-sm" :class="{ 'text-white' : !menuDetails }"
                                    @click="navigate('/my-policies')"></i>
                            </div>

                            <div class="custom-icon-bg bg-black-alpha-90" @click="showMenuDetails()"
                                :class="{ 'bg-yellow-500' : !menuDetails, 'bg-white' : menuDetails }">
            ...
            <template v-else-if="props.variation == 'no-back-arrow-white'">
                <div class="flex justify-content-between align-items-center px-3 py-2">
                    <div>
                        <label class="text-sm font-bold px-2">{{ page }}</label>
                    </div>
            ...
            <div class="overlay-menu bg-yellow-500" v-if="menuDetails">
                ...
                <div class="custom-brown-border-bottom px-3 py-2" @click="navigate('/lipa-pole-pole')">
                    <div class="flex align-items-center py-2 mb-2">
                        <i class="fa-wallet"
                            :class="{ 'fas' : page ==  'Lipa Pole Pole', 'far' : page !=  'Lipa Pole Pole'  }"></i>
                        <label class="text-sm px-2" :class="{ 'font-bold' : page ==  'Lipa Pole Pole'  }">Lipa Pole
                            Pole</label>
                    </div>
                </div>
                ...
                <div class="custom-brown-border-bottom px-3 py-2" @click="navigate('/faqs')">
                    <div class="flex align-items-center py-2 mb-2">
                        <i class="fa-messages-question"
                            :class="{ 'fas' : page ==  'FAQs', 'far' : page !=  'FAQs'  }"></i>
                ...
                <div class="custom-brown-border-bottom px-3 py-2" @click="navigate('/contact-us')">
                    <div class="flex align-items-center py-2 mb-2">
                        <i class="fa-headset"
                            :class="{ 'fas' : page ==  'Contact Us', 'far' : page !=  'Contact Us'  }"></i>
